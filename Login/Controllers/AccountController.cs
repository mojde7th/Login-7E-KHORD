...
namespace Login.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void submit(Yearmonth yearmonthh)
        {
            ...
            string yename = (from years in db.years
                            where
                              years.id == t
                            select new
                            {
                                yename = years.yearname
                            }).ToList().FirstOrDefault().yename;
            string moname = (from months in db.months
                            where
                              months.id == t2
                            select new
                            {
                                moname = months.monthname
                            }).ToList().FirstOrDefault().moname;
            ...
            if (compst.Contains("1"))
            {
               ...
               Employees.year.Contains(conc)
                ...
                ew.Cells["A2"].Value = "Username";
                ew.Cells["B2"].Value = " "+ TempData["idd"];
                ...
                ew.Cells["A4"].Value = "Report";
                ew.Cells["B4"].Value = moname+ yename ;
